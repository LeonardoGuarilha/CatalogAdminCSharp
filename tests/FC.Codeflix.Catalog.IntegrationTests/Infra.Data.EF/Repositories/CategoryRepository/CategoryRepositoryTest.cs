...
public class CategoryRepositoryTest
{
    ...
    public async Task Insert()
    {
        ...
        // Faço dessa forma o FindAsync para que eu não tenha o Tracking do EF.
        // Passo o true no CreateDbContext para preservar os dados criados a partir da linha 26.
    ...
    public async Task Get()
    {
        ...
        await dbContext.SaveChangesAsync(CancellationToken.None);
        // Passo outro ddbContext para não ter o Tracking do EF. Pode ser usado o AsNoTracking também.
