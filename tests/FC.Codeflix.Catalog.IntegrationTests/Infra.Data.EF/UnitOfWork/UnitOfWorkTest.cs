...
public class UnitOfWorkTest
{
    ...
    public async Task Commit()
    {
        ...
        var exampleListCategory = _fixture.GetExampleCategoriesList();
        await dbContext.AddRangeAsync(exampleListCategory);
        ...
        savedCategories.Should().HaveCount(exampleListCategory.Count);
    }
