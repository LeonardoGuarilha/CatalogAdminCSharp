...
public class UpdateCategoryTest
{
    ...
    public async Task UpdateCategory(DomainEntity.Category exampleCategory, UpdateCategoryInput input)
    {
        ...
        // Para não ter o tracking do EF no teste
    ...
    [Fact(DisplayName = nameof(UpdateThrowWhenNotFoundCategory))]
    [Trait("Integration/Application", "UpdateCategory - Use Cases")]
    public async Task UpdateThrowWhenNotFoundCategory()
    {
    ...
    public async Task UpdateThrowWhenCantInstantiateCategory(UpdateCategoryInput input, string expectedExceptionMessage)
    {
        var dbContext = _fixture.CreateDbContext();
